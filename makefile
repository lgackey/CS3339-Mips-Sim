...
main: ALU.o ControlUnit.o Memory.o Parser.o Pipeline.o RegisterFile.o src/main.cpp
	$(CXX) ALU.o ControlUnit.o Memory.o Parser.o Pipeline.o RegisterFile.o src/main.cpp -o "mips_sim"

debug: ALU.o ControlUnit.o Memory.o Parser.o Pipeline.o RegisterFile.o src/main.cpp
